      ...
      >
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-xs text-stone-400 mb-5">
            ...
            <Link href={localePath(lang, '/datenschutz')} className="text-amber-600 hover:underline font-medium">Datenschutzerklärung</Link>
            {' '}und unserem{' '}
            <Link href={localePath(lang, '/impressum')} className="text-amber-600 hover:underline font-medium">Impressum</Link>.
